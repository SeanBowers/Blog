...
namespace Blog.Services
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(string firstName, string lastName, string userName, string subject, string htmlMessage)
        {
            ...
            emailBody.HtmlBody = "Name: " +firstName + " " + lastName + " <br> Email: " + userName + " <br> Message: " + htmlMessage;
